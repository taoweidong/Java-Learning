...
/**
 * 【题目描述】： 有m个并行处理器，n个任务（n>m），按照短作业优先进行调度，计算处理完所有任务的耗时。
 * <p>
 * 【输入描述】： m n 两个正整数，m是处理器的个数，n是任务数;用空格分隔 t1 t2 ... tn 每个任务的处理时长；用空格分隔
 * <p>
 * 【输出描述】： 输出总处理时长
 * <p>
 * 【测试用例】： 【输入】： 3 5 5 4 3 1 10 【输出】： 13 ———————————————— 版权声明：本文为CSDN博主「kabuto_hui」的原创文章，遵循 CC 4.0 BY-SA
 * 版权协议，转载请附上原文出处链接及本声明。 原文链接：https://blog.csdn.net/kabuto_hui/java/article/details/90724006
 *
 * @author Taoweidong
 */
