    ...
    public void generateReport() {
        ...
        while (customers.hasNext()) {
            ...
            while (accounts.hasNext()) {
                ...
                /***
                 * Step 1: Use the instanceof operator to test what type of account we have and set account_type to an
                 * appropriate value, such as "Savings Account" or "Checking Account".
                 ***/
                ...
                /***
                 * Step 2: Print out the type of account and the balance. Feel free to use the currency_format formatter
