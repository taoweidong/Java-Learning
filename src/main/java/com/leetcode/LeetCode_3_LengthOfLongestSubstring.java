...
public class LeetCode_3_LengthOfLongestSubstring {
    public static void main(String[] args) {
        ...
        System.out.println(new LeetCode_3_LengthOfLongestSubstring().lengthOfLongestSubstring("abcabcbb"));

        System.out.println(new LeetCode_3_LengthOfLongestSubstring().lengthOfLongestSubstring("bbbbb"));

        System.out.println(new LeetCode_3_LengthOfLongestSubstring().lengthOfLongestSubstring("pwwkew"));
    }
