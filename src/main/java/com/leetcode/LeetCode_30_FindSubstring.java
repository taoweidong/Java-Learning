...
public class LeetCode_30_FindSubstring {
    public static void main(String[] args) {
        ...
        String[] words = {"a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a",
            ...
            "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a", "a",
            "a", "a", "a", "a"};
        List<Integer> result = new LeetCode_30_FindSubstring().findSubstring(s, words);
    ...
    public List<Integer> findSubstring(String s, String[] words) {
        ...
        int subStrLen = words[0].length() * words.length;
        ...
        while (right <= s.length()) {
            ...
            if (isMatch(subStr, words[0].length(), allWords)) {
                result.add(left);
            }
            left++;
            right++;
     ...
     * @return
     */
    private boolean isMatch(String subStr, int wordLength, Map<String, Integer> allWords) {

        Map<String, Integer> currentWord = new HashMap<>();
        for (int i = 0; i < subStr.length();) {
            String sub = subStr.substring(i, i + wordLength);
            currentWord.put(sub, currentWord.getOrDefault(sub, 0) + 1);
            i += wordLength;
        }
        for (Map.Entry<String, Integer> item : allWords.entrySet()) {
            if (!currentWord.containsKey(item.getKey()) || !currentWord.get(item.getKey()).equals(item.getValue())) {
                return false;
            }
        }
        return true;
